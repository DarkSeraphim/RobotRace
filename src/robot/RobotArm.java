...
public class RobotArm extends RobotPart
{
     ...
     */
    public RobotArm(Robot robot, float l, float d, boolean isLeft)
    {
        this.robot = robot;
        this.length = l;
        this.diametre = d;
    ...
    {
        float[] origin = new float[]{(isLeft ? 1 : -1)*robot.bodyDimensions[0]/2 + (isLeft ? 1 : -1)*0.05f*1.5f, 0f, +robot.bodyDimensions[2]/2-0.05f};
        gl.glPushMatrix();
    ...
    {  
            ...
            float[][] fingers = new float[][]{{0.22f, 0f}, // pinky :D
                                              {0.26f, 0f}, // ring finger
                                              {0.27f, 0f}, // middle finger
                                              {0.25f, 0f}}; // index finger
    ...
    /*
     * Getters and Setters for the length and diametre of the arm
     */
